...
class Book extends Publication {
    ...
    @Override
    public String toString() {
        return super.toString() + ", so trang: " + getPages();
    }
}
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            if (number == 1) {
                ...
                try {
                    // write
                    BufferedWriter writer = new BufferedWriter(new FileWriter("tape.txt"));
                    for (int i = 0; i < totalTapes; i++) {
                        writer.write(tapes[i].toString());
                        writer.write("\n");
                    }
                    writer.close();
                } catch (Exception e) {
                ...
                try {
                    ...
                    // read tape
                    BufferedReader tapeReader = new BufferedReader(new FileReader("tape.txt"));
                    String tapeLine;
                    while ((tapeLine = tapeReader.readLine()) != null) {
                        System.out.println(tapeLine);
                    }
                    tapeReader.close();
                } catch (Exception e) {
                    e.printStackTrace();
                ...
                System.out.println("chi chon tu 1 den 4.");
            }
        }
    }
}
